...
const App = () => {
  return (
    <Routes>
      ...
      <Route path="/temp-check" element={<ProtectedRoute><TempCheck /></ProtectedRoute>} />
      <Route path="/dashboard" element={<ProtectedRoute><Dashboard /></ProtectedRoute>} />

      {/* Session Monitor for testing - remove in production */}
      <Route path="/session-monitor" element={<ProtectedRoute><SessionMonitor /></ProtectedRoute>} />
    </Routes>
  );
};
